...
try
{
    ...
    _type = (switch (true) do {
        case (_classname isKindOf "Car"): { 0; };
        case (_classname isKindOf "Plane"): { 1; };
    ...
    (NULL, '%1', '%2', '""%3""', '1', '0', '""[[0, 0, 0], 0]""', '""[]""', '""[]""', '1', '1', '""""', '%4', '""""', '""""', '%5')", _accountID, _unitUID, _classname, _type, _plate])] call lils_database_fnc_query;
