...
try {
    ...
    ["lilcvi_personalcard_F", ["testss Pcard", "test"], [_accountID, (_pcardData select 0), _firstname, _lastname, (_pcardData select 1), (_pcardData select 2), (_pcardData select 3), (_pcardData select 4), (_pcardData select 5), (_pcardData select 6)]] call lilc_virtualInventory_fnc_add;
