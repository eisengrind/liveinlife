...
_config_packlog = "D:/Windows 10 Benutzer/agphe/Documents/GitHub/LiveInLife/LiveInLifeClient/packlog.log"
...
for directory in os.listdir(_argument_pathFrom):
    ...
    if os.path.isdir(directoryPath):
        if os.access(directoryPath, os.R_OK):
            ...
            subprocess.check_output('python "D:\\Users\\agphe\\Documents\\GitHub\\private\\LiveInLife\\LiveInLifeClient\\packSingle.py" "%s" "%s"' % (directoryPath, _argument_pathTo))
