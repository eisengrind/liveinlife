    ...
    if (lilc_player_isRespawning) then
    {
        ...
        do
        {
            _uiTextTimer ctrlSetStructuredText parseText format [
                ...
                ([lilc_respawn_currentTimeout] call lilc_common_fnc_secondsToDigital)
            ];
    ...
    else
    {
        ...
        else
        {
            ...
            try
            {
                ...
                do
                {
                    _uiTextTimer ctrlSetStructuredText parseText format["<t font='PuristaMedium' align='center' size='2.5'>%1</t>", ([(lilc_respawn_currentTimeout - (time - _time))] call lilc_common_fnc_secondsToDigital)];
                    sleep 1;
                };
