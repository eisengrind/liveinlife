...
try
{
	...
	["lilce_prison_punishment_started", [player, _punishmentName, _punishmentTimeout, _punishmentEscapeTimeout]] call CBA_fnc_localEvent;

	private _punishmentEscapeTimeUntilFree = (["escapeTimeUntilFree", "NUMBER", (10 * 60), _punishmentConfig] call lilc_common_fnc_getSetting);
	...
	_uiTextJailInfo ctrlSetStructuredText parseText format[
		...
		{
			([lilc_prison_waitingTime] call lilc_common_fnc_secondsToDigital);
		}
		else
		{
			"Unbegrenzt";
