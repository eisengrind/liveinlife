...
if !(isClass (missionConfigFile >> "CfgVehicleShops" >> lilc_shopVehicles_currentShop >> "vehicles")) exitWith {};
...
if (lilc_shopVehicles_vehicleIndex == 0) then {
    lilc_shopVehicles_vehicleIndex = ((count _vehicles) - 1);
} else {
