...
class lilc_RscControlsGroup {
	...
	class VScrollBar : lilc_RscScrollBar
	{
		width = 0.021;
		autoScrollEnabled = 1;
	};
	
	class HScrollBar : lilc_RscScrollBar
	{
		height = 0.028;
	};
...
class lilc_RscControlsGroupNoScrollbars : lilc_RscControlsGroup {
...
class lilc_RscHud 
{
	...
	colorText[] = { 1 , 1 , 1 , 1 };
	font = "RobotoCondensed"; //font = "PuristaSemiBold";
	sizeEx = 0.025;
	h = 0.25;
	text = "";
};
...
class lilc_RscLine : lilc_RscText {
	idc = -1;
	style = 176;
	x = 0.17;
	y = 0.48;
...
class lilc_RscTextMulti : lilc_RscText
{
	linespacing = 1;
	style = 0 + 16 + 0x200;
};

class lilc_RscPictureKeepAspect : lilc_RscPicture 
{
	style = 0x30 + 0x800;
};
...
class lilc_RscButtonTextOnly : lilc_RscButton {
	SizeEx = "(			(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 0.8)";
	colorBackground[] = {1, 1, 1, 0};
...
class lilc_RscButtonMenu : lilc_RscShortcutButton {
	idc = -1;
	type = 16;
	style = "0x02 + 0xC0";
	default = 0;
	...
	class Attributes
	{
		font = "PuristaLight"; //font = "PuristaLight";
		color = "#E5E5E5";
		align = "left";
		shadow = "false";
	};
...
class lilc_RscShortcutButtonMain : lilc_RscShortcutButton {
	idc = -1;
	style = 0;
	default = 0;
	w = 0.313726;
...
class lilc_RscEdit {
	...
	shadow = 2;
	sizeEx = "(			(			(			((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 1)";
	colorBackground[] = {0.25,0.25,0.25,0.70};
...
class lilc_RscBackground : lilc_RscText {
	type = 0;
	IDC = -1;
	style = 512;
	shadow = 0;
...
class lilc_RscHTML {
	...
	class IMG : lilc_RscPicture {
		align = "left";
	};
};

class lilc_RscHitZones {
	x = 0;
	y = 0;
	w = 0.1;
	h = 0.1;
...
class lilc_RscCombo {
	...
	class ComboScrollBar : lilc_RscScrollBar {};
};

class lilc_RscToolbox {
	colorText[] = {0.95, 0.95, 0.95, 1};
	color[] = {0.95, 0.95, 0.95, 1};
...
class lilc_RscShortcutButton2 {
	...
	animTextureOver = "#(argb,8,8,3)color(0,0,0,0.3)";
	animTextureFocused = "#(argb,8,8,3)color(0,0,0,0)";
	animTexturePressed = "#(argb,8,8,3)color(0,0,0,0.6)";
	periodFocus = 0;
	periodOver = 0;
	class HitZone
	{
...
class lilc_RscTitle_darkBlueText : lilc_RscTitle {
	text = "";
...
class lilc_RscText_whiteBackground : lilc_RscText {
	colorBackground[] = {0.7843, 0.7843, 0.7843, 1};
};

class lilc_RscText_darkBlueBackground : lilc_RscText {
	colorBackground[] = {0.0863, 0.1451, 0.2118, 1};
};

class lilc_RscButtonMenu_greyBackground : lilc_RscButtonMenu {
	text = "";
    font = "PuristaSemibold";
	colorText[] = {1, 1, 1, 1};
...
class lilc_RscButtonMenu_darkBlueBackground : lilc_RscButtonMenu {
	text = "";
    font = "PuristaSemibold";
	colorText[] = {1, 1, 1, 1};
...
class lilc_RscMapControlGreen
{
	...
	sizeEx = 0.04;
	colorSea[] = {0.467,0.631,0.851,0.5};
	colorForest[] = {(42/255), (179/255), 0, 0.8};
	colorRocks[] = {0,0,0,0};
	colorCountlines[] = {0, (150/255), (64/255), 0.7};
	colorMainCountlines[] = {(127/255), (245/255), (90/255), 0.7};
	colorCountlinesWater[] = {0, (150/255), (64/255), 0.7};
	colorMainCountlinesWater[] = {(127/255), (245/255), (90/255), 0.7};
	colorForestBorder[] = {0, 0, 0, 0};
	colorRocksBorder[] = {0, 0, 0, 0};
	colorPowerLines[] = {0.2, 0.2, 0.2, 1};
	...
	colorRoadsFill[] = {1,1,1,1};
	colorMainRoadsFill[] = {1,0.6,0.4,1};
	colorGrid[] = {0.8, 0.8, 0.8, 0.6};
	colorGridMap[] = {0.8, 0.8, 0.8, 0.6};
	stickX[] = {0.2,{"Gamma",1,1.5}};
	stickY[] = {0.2,{"Gamma",1,1.5}};
	class Legend
	{
