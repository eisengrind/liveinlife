...
class GVAR(atm) {
    ...
    class controlsBackground {
        class FrameBackgroundBackground : lilc_RscPicture {
            idc = 1511;
            text = PATHTOF(data\ui\atm_background.paa);
        ...
        class PictureButton1 : lilc_RscPicture {
            idc = 1514;
            text = PATHTOF(data\ui\atm_button_left.paa);
        ...
        class PictureButton5 : PictureButton1 {
            idc = 1518;
            text = PATHTOF(data\ui\atm_button_right.paa);
        ...
        class PictureEditValue : lilc_RscPicture {
            idc = 1539;
            text = PATHTOF(data\ui\atm_edit_background.paa);
    ...
    class controls {
        ...
        class ButtonButton1 : lilc_RscButtonMenu {
            ...
            animTextureOver = PATHTOF(data\ui\atm_button_left_hover.paa);
            animTextureFocused = "#(argb,8,8,3)color(0,0,0,0)";
            animTexturePressed = PATHTOF(data\ui\atm_button_left_pressed.paa);
        ...
        class ButtonButton5 : ButtonButton1 {
            idc = 1526;
            animTextureOver = PATHTOF(data\ui\atm_button_right_hover.paa);
            animTexturePressed = PATHTOF(data\ui\atm_button_right_pressed.paa);
            x = 0.537604 * safezoneW + safezoneX;
            y = 0.430296 * safezoneH + safezoneY;
            w = 0.108281 * safezoneW;
            h = 0.0303333 * safezoneH;
        ...
        class FrameFrame : lilc_RscPicture {
            idc = -1;
            text = PATHTOF(data\ui\atm_frame.paa);
            x = 0.298906 * safezoneW + safezoneX;
            y = 0.115 * safezoneH + safezoneY;
            w = 0.402187 * safezoneW;
            h = 0.726 * safezoneH;
