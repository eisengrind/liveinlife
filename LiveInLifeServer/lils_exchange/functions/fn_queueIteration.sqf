			...
			switch (_type) do
			{
				case "buy":
				{
					...
					*/
					...
					[(format["INSERT INTO exchange_logs (classname, exchangeName, `type`, timestampadded, active, accountID) VALUES ('%1', '%2', '0', UNIX_TIMESTAMP(NOW()), 1, '%3')", (str _classname), (str _exchangeName), _unitAccountID])] call lils_database_fnc_query;
				...
				case "sell":
				{
					...
					*/
					...
					[(format["INSERT INTO exchange_logs (classname, exchangeName, `type`, timestampadded, active, accountID) VALUES ('%1', '%2', '1', UNIX_TIMESTAMP(NOW()), 1, '%3')", (str _classname), (str _exchangeName), _unitAccountID])] call lils_database_fnc_query;
